...
(function (i, V, l, n) {
    var j = function (e) {
        ...
        function w(a, b, c, d) {
            ...
            if (null === c && null !== g.sDefaultContent)c = g.sDefaultContent; else if ("function" ===
                typeof c)return c();
        ...
        function Ea(a) {
            ...
            for (f = 0; f < b; f++)d = a.aoColumns[f].mDataProp, c.push({name:"mDataProp_" + f, value:"function" ===
                typeof d ? "function" : d});
    ...
    j.defaults = {aaData:null, aaSorting:[
        ...
        }, fnStateSaveParams:null, iCookieDuration:7200, iDeferLoading:null, iDisplayLength:10, iDisplayStart:0, iScrollLoadGap:100, iTabIndex:0, oLanguage:{oAria:{sSortAscending:": activate to sort column ascending", sSortDescending:": activate to sort column descending"}, oPaginate:{sFirst:"第一页", sLast:"最后一页", sNext:"下一页", sPrevious:"上一页"}, sEmptyTable:"目前没有任何条目", sInfo:"显示第 _START_ 到 _END_ 个条目     共 _TOTAL_ 个条目",
            sInfoEmpty:"显示第 0 到 0 个条目     共 0 个条目", sInfoFiltered:"(从目前的 _MAX_ 个条目中搜索)", sInfoPostFix:"", sInfoThousands:",", sLengthMenu:"Show _MENU_ entries", sLoadingRecords:"正在加载...", sProcessing:"正在处理...", sSearch:"搜索:", sUrl:"", sZeroRecords:"没有符合的条目"}, oSearch:i.extend({}, j.models.oSearch), sAjaxDataProp:"aaData", sAjaxSource:null, sCookiePrefix:"SpryMedia_DataTables_", sDom:"lfrtip", sPaginationType:"two_button", sScrollX:"", sScrollXInner:"", sScrollY:"", sServerMethod:"GET"};
